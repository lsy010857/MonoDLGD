...
class Det3DTransformer(nn.Module):
    ...
    def forward(self, intermediate_output, query_embeds, depth_pos_embed, attn_mask):
        ...
        reference_points_cat = intermediate_output['reference_points_cat']
        ...
        hs, inter_references = self.decoder(
            ...
            depth_pos_embed,
            mask_depth,
            bs=bs, reference_points_cat=reference_points_cat, attn_mask=attn_mask)
...
class DepthAwareDecoderLayer(nn.Module):
    ...
    def forward(self,
        ...
        if self.training:
            ...
            tgt4 = torch.stack(tgt2[:num_noise].split(bs, dim=1)).mean(dim=0).transpose(0,
                                                                                        1)  #
...
class DepthAwareDecoder(nn.Module):
    ...
    def forward(self, tgt, reference_points, src, src_spatial_shapes, src_level_start_index, src_valid_ratios,
                ...
                reference_points_cat=None, attn_mask=None):
        output = tgt
